...
import 'package:untitled05/core/presentation/pages/movie-details-page/movie_details_page_view_model.dart';
...
class MovieDetailsPageView extends StatelessWidget {
  static const String routeName = "/movie-details-page";
  static const ValueKey<String> routeKey = ValueKey<String>("movie-details-page",);
  /////////////////////////
  final int _movieId;
  /////////////////////////
  const MovieDetailsPageView(this._movieId,) : super(key: null,);
  /////////////////////////
  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<MovieDetailsPageViewModel>.reactive(
      ...
      viewModelBuilder: () => MovieDetailsPageViewModel.create(_movieId,),
      onViewModelReady: (viewModel,) => viewModel.onModelReady(),
      builder: (_, viewModel, __,) => const _MovieDetailsPageView(key: routeKey,),
    );
  }
}

class _MovieDetailsPageView extends ViewModelWidget<MovieDetailsPageViewModel> {
  @override
  bool get reactive => true;
  /////////////////////////
  const _MovieDetailsPageView({Key? key,}) : super(key: key,);
  /////////////////////////
  @override
  Widget build(BuildContext context, MovieDetailsPageViewModel viewModel,) {
    return WillPopScope(
      onWillPop: () async {
        viewModel.onClose();
        return true;
      ...
      child: Scaffold(
        ...
        body: Builder(
          builder: (_,) {
            if(viewModel.isBusy) {
              return const SizedBox.expand(child: CustomLoader(),);
            }
            else if (viewModel.hasError) {
              return const SizedBox.expand(child: Center(child: Text("Sorry Some Error Has Occurred",),),);
            }
            else {
