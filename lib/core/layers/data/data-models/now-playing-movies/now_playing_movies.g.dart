...
NowPlayingMovies _$NowPlayingMoviesFromJson(Map<String, dynamic> json,) {
  return NowPlayingMovies(
    dates: json['dates'] == null ? null : DateRange.fromJson(json['dates'] as Map<String, dynamic>,),
    page: json['page'] as int?,
    results: (json['results'] as List<dynamic>?)?.map((e,) => NowPlayingMovie.fromJson(e as Map<String, dynamic>,),).toList(),
    totalPages: json['totalPages'] as int?,
    totalResults: json['totalResults'] as int?,
  );
}

Map<String, dynamic> _$NowPlayingMoviesToJson(NowPlayingMovies instance,) => <String, dynamic>{
...
Map<String, dynamic> _$NowPlayingMovieToJson(NowPlayingMovie instance) => <String, dynamic>{
